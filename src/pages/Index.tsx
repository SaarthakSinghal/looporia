    ...
    <div className="min-h-screen py-8 px-4 relative crt-overlay">
      ...
      <main>
        ...
        <div className="max-w-3xl mx-auto mt-12 bg-retro-beige retro-border p-6 font-retro text-lg">
          ...
          <p className="mb-4">
            Welcome to LOOPORIA, a nostalgic journey back to the days of classic
            media players like Winamp, Windows Media Player, and RealPlayer.
          </p>
          <p className="mb-4">
            This retro-inspired music player combines vintage aesthetics with
            modern web technologies, giving you that warm fuzzy feeling of the
            early internet era.
          </p>
          <div className="text-center mt-6">
            <span className="px-3 py-1 bg-retro-brown-2 text-retro-beige inline-block mx-1">
              HTML5
            </span>
            <span className="px-3 py-1 bg-retro-brown-2 text-retro-beige inline-block mx-1">
              React
