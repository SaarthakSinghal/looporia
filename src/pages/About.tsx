    ...
    <div className="min-h-screen py-8 px-4 relative crt-overlay">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-retro-beige retro-border p-6 font-retro text-lg">
          <h2 className="text-2xl font-pixel text-retro-brown-3 mb-4 text-center">
            OUR STORY
          </h2>

          <p className="mb-4">
            LOOPORIA was born from a deep nostalgia for the early days of
            digital music players. Remember the days of Winamp, Windows Media
            Player, and RealPlayer? Those chunky interfaces, visualizers, and
            the excitement of creating your first playlist?
          </p>

          <p className="mb-4">
            We've recreated that magical experience with modern technology. Our
            music player combines the aesthetic charm of the 90s and early 2000s
            with the power and convenience of today's web technologies.
          </p>

          <p className="mb-6">
            Whether you're an old-school music lover who remembers the dial-up
            internet days, or a newcomer curious about the retro digital
            experience, LOOPORIA offers a unique way to enjoy and organize your
            music collection.
          </p>
          ...
          <div className="text-center mb-6">
            <span className="px-3 py-1 bg-retro-brown-2 text-retro-beige inline-block m-1">
              React
            </span>
            <span className="px-3 py-1 bg-retro-brown-2 text-retro-beige inline-block m-1">
              TypeScript
